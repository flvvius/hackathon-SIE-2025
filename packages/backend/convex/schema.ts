...
export default defineSchema({
	...
	users: defineTable({
		...
		publicKey: v.string(), // Cheie publică pentru encriptare end-to-end
		createdAt: v.number(),
		updatedAt: v.number(),
	})
	...
	// Local Sync State - pentru sincronizare cu local storage
	syncState: defineTable({
		userId: v.id("users"),
		deviceId: v.string(), // Identificator unic pentru device
		lastSyncAt: v.number(),
		pendingChanges: v.number(), // Număr de modificări în așteptare
	})
		.index("by_user", ["userId"])
